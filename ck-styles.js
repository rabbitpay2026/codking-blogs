(function () {
  ...
  function inject() {
    if (document.getElementById('ck-injected-styles')) return;
    var el = document.createElement('style');
    el.id = 'ck-injected-styles';
    el.setAttribute('data-source', 'ck-styles.js');
...
(function () {
  ...
  function hydrate() {
    ...
    for (var i = 0; i < mounts.length; i++) {
      var m = mounts[i];
      if (m.getAttribute('data-ck-hydrated')) continue;
      m.setAttribute('data-ck-hydrated', '1');
